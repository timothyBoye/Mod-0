        ...
        if (this.needsUpdate)
        {
            ...
            if (!chunkcache.extendedLevelsInChunkCache())
            {
                ...
                for (int l1 = 0; l1 < 2; ++l1)
                {
                            ...
                            for (int k2 = i; k2 < l; ++k2)
                            {
                                ...
                                if (l2 > 0)
                                {
                                    if (!flag2)
                                    {
                                        ...
                                        GL11.glScalef(f, f, f);
                                        GL11.glTranslatef(8.0F, 8.0F, 8.0F);
                                        //ForgeHooksClient.beforeRenderPass(l1); Noop fo now, TO DO: Event if anyone needs
                    ...
                    if (flag2)
                    {
                        //ForgeHooksClient.afterRenderPass(l1); Noop fo now, TO DO: Event if anyone needs
